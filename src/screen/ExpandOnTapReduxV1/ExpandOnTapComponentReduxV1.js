...
import { expandOnTap } from './ExpandOnTapAction';
import {
    Button,
    Card,
    CardSection
...
class ExpandOnTapComponentReduxV1 extends Component {
...
export default connect(mapStateToProps, { expandOnTap })(ExpandOnTapComponentReduxV1);
